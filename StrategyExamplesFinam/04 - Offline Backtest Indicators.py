...
if __name__ == '__main__':
    ...
    ticker2 = 'TQBR.LKOH'  # Ticker in the format <Ticker code>
    ...
    # data = store.getdata(timeframe=bt.TimeFrame.Days, compression=1, dataname=ticker, fromdate=fromdate, live_bars=False)  # set True here - if you need to receive live bars
    # data2 = store.getdata(timeframe=bt.TimeFrame.Days, compression=1, dataname=ticker2, fromdate=fromdate, live_bars=False)  # set True here - if you need to receive live bars
